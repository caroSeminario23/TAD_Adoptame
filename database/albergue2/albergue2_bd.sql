...
CREATE SEQUENCE SEQ_caracteristica_complementaria
START WITH 1
INCREMENT BY 1;
...
BEGIN
  SELECT SEQ_caracteristica_complementaria.NEXTVAL
...
CREATE SEQUENCE SEQ_tipo_mascota
START WITH 1
INCREMENT BY 1;
...
REFERENCING NEW AS NEW FOR EACH ROW
BEGIN
  SELECT SEQ_tipo_mascota.NEXTVAL
